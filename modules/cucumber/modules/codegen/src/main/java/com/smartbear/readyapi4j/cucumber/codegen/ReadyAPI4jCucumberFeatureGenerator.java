package com.smartbear.readyapi4j.cucumber.codegen;
...
public class ReadyAPI4jCucumberFeatureGenerator extends DefaultCodegen implements CodegenConfig {
    ...
    public String getName() {
        return "ReadyAPI4jCucumberFeatureGenerator";
    }

    public String getHelp() {
        return "Generates ReadyAPI4j Feature file(s)";
    }

    public ReadyAPI4jCucumberFeatureGenerator() {
        super();

        outputFolder = "generated-test-resources/features";
        apiTemplateFiles.put("feature.mustache", ".feature");
        templateDir = "ReadyAPI4jCucumberFeatureGenerator";
    }

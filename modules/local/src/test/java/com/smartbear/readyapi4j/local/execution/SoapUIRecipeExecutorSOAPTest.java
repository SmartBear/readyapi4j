...
import com.smartbear.readyapi4j.util.soap.LocalService;
...
import static com.smartbear.readyapi4j.util.PortFinder.portFinder;
...
public class SoapUIRecipeExecutorSOAPTest {
    ...
    private static final String XPATH_TO_ASSERT = "declare namespace ns2='http://soap.util.readyapi4j.smartbear.com/';\n" +

...
public class SwaggerExecutionTest extends ProjectExecutionTestBase {
    ...
    public void executesSwaggerFile() throws Exception {
        ...
        when(apiWrapper.postSwagger(any(File.class), any(SwaggerFormat.class), any(String.class), any(String.class), anyBoolean(),
                any(HttpBasicAuth.class))).thenReturn(endReport);
        Execution execution = swaggerApiValidator.validateApiSynchronously(getSwaggerFile(), SwaggerFormat.JSON, "http://google.com", "http://google.com");
    ...
    public void throwsExceptionIfSwaggerFileDoesNotExist() throws Exception {
        new TestServerClient("localhost").createApiValidator().validateApiSynchronously(new File("non-existing-file.json"), SwaggerFormat.JSON, null, "http://google.com");
    }
    ...
    public void manualTest() {
        ...
        Execution execution = testServerClient.createApiValidator().validateApiSynchronously(swaggerFile, SwaggerFormat.JSON, null, "http://petstore.swagger.io");
